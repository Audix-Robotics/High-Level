...
def generate_launch_description():
    ...
    # ── sim cmd bridge: corrected ROS Twist → Gz VelocityControl ─────
    bridge_cmd_vel = Node(
        package='ros_gz_bridge',
        executable='parameter_bridge',
        output='screen',
        arguments=['/cmd_vel_sim@geometry_msgs/msg/Twist]gz.msgs.Twist'],
    )
    ...
    # VelocityControl drives the base from /cmd_vel_sim in this sim path, so the
    # wheel velocity controller is intentionally not spawned.
